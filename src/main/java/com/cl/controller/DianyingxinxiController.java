...
public class DianyingxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,DianyingxinxiEntity dianyingxinxi,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date shangyingriqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date shangyingriqiend,
		HttpServletRequest request){
        EntityWrapper<DianyingxinxiEntity> ew = new EntityWrapper<DianyingxinxiEntity>();
                if(shangyingriqistart!=null) ew.ge("shangyingriqi", shangyingriqistart);
                if(shangyingriqiend!=null) ew.le("shangyingriqi", shangyingriqiend);
