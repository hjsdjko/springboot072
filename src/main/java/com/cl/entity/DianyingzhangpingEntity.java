...
public class DianyingzhangpingEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public DianyingzhangpingEntity() {
		
	}
	
	public DianyingzhangpingEntity(T t) {
		try {
	...
	private String zhangpingpingfen;
	 ...
	 * 设置：长评评分
	 */
	public void setZhangpingpingfen(String zhangpingpingfen) {
		this.zhangpingpingfen = zhangpingpingfen;
	}
	/**
	 * 获取：长评评分
	 */
	public String getZhangpingpingfen() {
		return zhangpingpingfen;
	}
	/**
	 * 设置：评价时间
	 */
